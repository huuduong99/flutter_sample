...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, imagePath: $imagePath, price: $price, photographer: $photographer, name: $name, details: $details)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, imagePath, price, photographer, name, details);
...
abstract class _User implements User {
  const factory _User(
      ...
      final String? photographer,
      final String? name,
      final String? details}) = _$UserImpl;
